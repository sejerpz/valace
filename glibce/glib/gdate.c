                         ...
                         GDateParseTokens *pt)
{
	...
	SetLocaleInfo(lcid, LOCALE_ITIME, NULL);
	int buffsize = GetLocaleInfo(lcid, LOCALE_ITIME, NULL, 0);
	gchar locale[buffsize];
	GetLocaleInfo(lcid, LOCALE_ITIME, locale, buffsize);
#else
